...
# try out several different algorithms: DecisionTreeClassifier(), KNeighborsClassifier(), GaussianNB(), \
# and RandomForestClassifier()
# randomizedPCA to reduce dimensionality and make algorithms run better with fewer inputs
params = {
    ...
    # n_estimators also included 5 and 25 but have been omitted to shorten computing time
